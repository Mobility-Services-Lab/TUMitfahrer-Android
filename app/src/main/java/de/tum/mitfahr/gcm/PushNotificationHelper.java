...
public class PushNotificationHelper {
	...
	// Android Project Id
	// TODO change this ID to production one //this comment is for public github
	private final static String SENDER_ID = "919031243448";
	    ...
	    private class RegisterToPlayService extends AsyncTask<Void, String, String> {
	        ...
	        protected String doInBackground(Void... params) {
	            ...
	            try {
	            	...
	            	Log.i(TAG, "Error RegistrationId: "+ex.getMessage());
